...
- **Format:** Multi-stage calculations, state tracing and engineering decisions
...
These examples intentionally combine material from all three days. Use a
calculator or a short Python check, but show equations, units, assumptions and
