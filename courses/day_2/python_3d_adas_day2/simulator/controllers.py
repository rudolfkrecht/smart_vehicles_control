"""Reference controllers for the Day 2 integrated ADAS simulator."""
...
class ReferenceController:
    """Day 1 PI speed control plus Day 2 adaptive Pure Pursuit."""
    ...
    def preview_distance(self, speed: float) -> float:
        """Request the path point used by Pure Pursuit."""
