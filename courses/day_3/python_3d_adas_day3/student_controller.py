"""Student-editable Day 3 controller.

Day 1 PI speed control and Day 2 Pure Pursuit are complete. During Day 3,
replace the cruise-only target with an adaptive cruise-control target.
"""
...
class StudentController:
    def __init__(self) -> None:
        # Validated Day 1 longitudinal controller.
        self.KP = 0.15
        self.KI = 0.005
        self.integral_error = 0.0

        # Validated Day 2 lateral controller.
        self.BASE_LOOKAHEAD_M = 4.0
        self.SPEED_GAIN_S = 0.35
        self.WHEELBASE_M = 2.8
        self.MAX_STEERING_RAD = math.radians(28.0)

        # Day 3 ACC parameters. Tune these during Lessons 5 and 6.
    ...
    def update(self, observation: Observation) -> ControlCommand:
        # Day 3 TODO: replace this cruise-only target with an ACC target.
        desired_gap = (
        ...
        # Completed Day 2 Pure Pursuit controller.
