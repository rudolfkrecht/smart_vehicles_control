...
## 0–7 min — Observe the reference controller
...
## 7–12 min — Establish the unsafe cruise-only baseline
...
## 12–18 min — Calculate desired gap
...
## 18–29 min — Implement the continuous ACC target
...
## 29–35 min — Add visible Brake and Emergency logic
...
## 35–41 min — Run a repeatable guided test
...
## 41–44 min — Graphical safety check
