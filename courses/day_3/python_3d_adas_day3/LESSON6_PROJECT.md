...
- **Duration:** 45 minutes
- **Format:** Individual controller-development task
...
## 0–5 min — Prepare the experiment
...
## 5–12 min — Establish the Lesson 5 baseline
...
## 30–36 min — Select using a hierarchy
...
## 36–41 min — Final graphical test
...
## 41–43 min — Produce the final evidence
