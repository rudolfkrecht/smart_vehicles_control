...
- **Duration:** 45 minutes
- **Format:** Individual controller validation
...
## 0–5 min — Prepare and freeze the inherited controller
...
## 5–11 min — Confirm the nominal case
...
## 11–18 min — Confirm the radar-dropout case
...
## 18–25 min — Test actuator and lateral robustness
...
## 25–32 min — Run the complete evaluation suite
...
## 32–36 min — Diagnose before changing anything
...
## 36–40 min — Graphical combined-scenario check
...
## 40–43 min — Produce the final evidence
