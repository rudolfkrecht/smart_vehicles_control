"""Student-editable Day 4 safety-supervisor controller.

The Day 1 PI controller, Day 2 Pure Pursuit controller and Day 3 ACC layer are
complete. Add the marked sensor-health fallback during Lessons 5 and 6.
"""
...
class StudentController:
    ...
    def update(self, observation: Observation) -> ControlCommand:
        ...
        # Day 4 TODO:
        # If the range sensor is unhealthy or its measurement is too old,
        # override the ACC target and request a controlled safe stop.
        ...
        # Day 4 TODO: in SAFE_STOP, enforce at least
        # self.SAFE_STOP_MIN_BRAKE normalized braking.
