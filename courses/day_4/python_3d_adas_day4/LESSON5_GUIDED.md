...
- **Duration:** 45 minutes
- **Format:** Guided implementation in pairs
...
## 0–6 min — Observe the complete reference
...
## 6–12 min — Establish the unsafe Day 3 baseline
...
## 12–18 min — Trace the existing control flow
...
## 18–27 min — Implement the sensor-health override
...
## 27–33 min — Add minimum fallback braking
...
## 33–39 min — Run the repeatable guided test
...
## 39–43 min — Diagnose common errors
...
## 43–45 min — Graphical checkpoint
