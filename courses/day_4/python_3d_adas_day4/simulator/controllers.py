"""Reference controllers for the cumulative Day 4 ADAS simulator."""
...
class ReferenceController:
    """Days 1–3 controller plus a Day 4 sensor-fault supervisor."""
    ...
    def update(self, observation: Observation) -> ControlCommand:
        ...
        if mode == "BRAKE":
            ...
            signed_command = min(signed_command, -0.45)
