...
- **Duration:** 45 minutes
- **Format:** Instructor-led implementation in pairs
- **Starting controller:** `student_controller.py`
- **Main outcome:** A tested PI cruise controller with anti-windup

The purpose of this lesson is to transfer the controller from the one-dimensional
PyQt experiment into a vehicle that must also move around a closed 3D road.
The supplied Pure Pursuit controller handles steering. Students work only on
...
The student controller receives an `Observation`. The most important Day 1
members are:
...
## 0–10 min — Inspect and run the baseline
...
## 10–20 min — Tune proportional control
...
## 30–40 min — Prevent integral windup
...
## 40–45 min — Evidence-based conclusion
