...
class SceneBuilder:
    ...
    def build(
        ...
        primitives.extend(
            self._car_primitives(projector, vehicle, slope)
        )
    ...
    def _car_primitives(
        ...
        add_box((0.0, 0.0, 0.58), (4.4, 1.9, 0.62), ("#2f80ed", "#2061b5", "#17477f"))
        add_box((-0.25, 0.0, 1.08), (2.35, 1.68, 0.72), ("#a7d8f0", "#4d7993", "#34576d"))
        for x in (-1.42, 1.42):
            for y in (-1.0, 1.0):
